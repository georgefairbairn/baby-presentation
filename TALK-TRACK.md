...
**Answer is touch.** Good icebreaker. Add these after the reveal.
...
- The food rules feel overwhelming. Short version, nothing raw or undercooked,
  no soft mould-ripened cheeses, no pâté. Risk is listeria and toxoplasmosis. Rare, but serious.
- Health Canada says caffeine should stay under 300mg, about two coffees. Doesn't have to be
  zero.
...
- The trade-off is that the OB you see may not be the one on call when you deliver.
...
Main message is simple. If in doubt, call. Nobody will think you're overreacting.
...
- BC started funding IVF in July 2025, up to $19,000 for one cycle, income-tested
  with the full amount below $100k, applicant 41 or under. Good that it exists, and hopefully irrelevant.
- The line that matters is this. **The plan is September, and if it isn't September
  that's still completely normal.** Neither of us treats month three as a failure.

## Slide 14: Pregnancy Do's & Don'ts
Mostly self-explanatory. Worth adding a few things.
...
- Risk drops fast, 1.7% at 12 weeks and 0.5% by 16.
...
## Slide 22: Stage 3 Delivering the Placenta
...
- We choose in advance, either managed (faster, less bleeding) or physiological.
- Much easier than what just happened. Most people barely notice because they're
  holding their baby.

## Slide 23: Signs It's Time to Go to Hospital
Reinforce 5-1-1, then add this. "If the waters break, note the time and the colour.
...
- Key message is that you can change your mind at any point. Start natural, want an
...
- Vitals watched for a couple of hours, so blood pressure, bleeding and temperature.
...
**Answer is ~2,500–3,000.** "Yes, really."
...
## Slide 33: Surviving the First 2 Weeks
...
- Practically, sterilise everything, follow the instructions exactly on water
...
Non-negotiable, and these exist to prevent SIDS.
...
## Slide 39: Milestones 0–6 Months
...
## Slide 40: Milestones 7–12 Months
...
Same traffic lights. These are the ones to land.
...
- Dehydration shows as no wet nappy for 6+ hours, sunken fontanelle, crying without tears.
...
Let it play out, then say "a lot of that is one-time purchases, and a lot of it is
avoidable."

## Slide 46: One-Time Costs
- Car seat is legally required. Don't buy second-hand unless we know its full
  history, no accidents.
- On the stroller, we don't need the most expensive one. Think about what we'll actually
  use it for.
...
Activities, dental, prescriptions, a bigger car eventually. Three that people forget.
